                ...
                <div className="footer-content">
                    <div className="footer-brand">
                        <div className="footer-logo">
                            <EditableText id="footer-logo" defaultValue="GOSHEN Clothing" />
                        </div>
                        <div className="footer-description">
                            <EditableText
                                id="footer-brand-desc"
                                tagName="p"
                                defaultValue="Celebrating African heritage through contemporary fashion. Handcrafted with love in Ghana."
                            />
                        </div>
                    </div>

                    <div className="footer-section">
                        <h4><EditableText id="footer-links-title" defaultValue="Quick Links" /></h4>
                    ...
                    <div className="footer-section">
                        <h4><EditableText id="footer-contact-title" defaultValue="Contact" /></h4>
                        <ul className="footer-links">
                    ...
                    <div className="footer-section">
                        <h4><EditableText id="footer-follow-title" defaultValue="Follow Us" /></h4>
                        <ul className="footer-links">
